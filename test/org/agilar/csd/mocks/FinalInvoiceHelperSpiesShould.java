...
public class FinalInvoiceHelperSpiesShould {
	...
	@Test
	public void VerifyNotPrintWhenSendEmailInvoiceToCustomer() {
		PrepareMockOKInvoicesSenders();
		customer.setIfWantEmailInvoice(true);
		finalInvoiceStep.handleInvoice(invoice, customer);
		Mockito.verifyZeroInteractions(printerService); //Nothing should be  emailed
		}
