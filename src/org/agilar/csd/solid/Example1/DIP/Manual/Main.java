...
public class Main {
   ...
   /* public static void main(String[] args) {
    ...
    public static void main(String[] args) throws IOException, ParserConfigurationException, SAXException, InvalidKeyException, URISyntaxException {
            ...
            InputParser inputParser = new JsonInputParser();
            DocumentSerializer jsonSerializer = new JsonDocumentSerializer() ;
            DocumentStorageFactory documentStorage = new DocumentStorageFactory();
            FormatConverter formatConverter = new FormatConverter(documentStorage,inputParser,jsonSerializer);
