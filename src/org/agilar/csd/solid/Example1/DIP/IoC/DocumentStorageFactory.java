...
public class DocumentStorageFactory implements StorageFactory {
	 ...
	 */
	/* (non-Javadoc)
	 * @see org.agilar.csd.solid.Example1.DIP.IoC.StorageFactory#GetInputRetrieverForFileName(java.lang.String)
	 */
	@Override
	 ...
	 */
	/* (non-Javadoc)
	 * @see org.agilar.csd.solid.Example1.DIP.IoC.StorageFactory#GetDocumentPersisterForFileName(java.lang.String)
	 */
	@Override
